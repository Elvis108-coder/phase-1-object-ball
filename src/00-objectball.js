function gameObject() {
  ...
  console.log(gameObject()); // Check the full game object
  console.log(numPointsScored("Ben Gordon")); // Example function call
  console.log(shoeSize("Brook Lopez")); // Example function call
